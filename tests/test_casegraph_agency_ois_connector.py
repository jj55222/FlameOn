...
def test_connector_yields_count_matches_fixtures():
    ...
    # 9 page records (one per fixture; +1 for sheriff bodycam fixture)
    assert by_kind.get("agency_page", 0) == 9
    # 6 media links across the fixture set (mp4, protected, YouTube, Vimeo,
    # 911 audio, sheriff bodycam mp4)
    assert by_kind.get("agency_media_link", 0) == 6
